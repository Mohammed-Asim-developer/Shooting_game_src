...
//test
            ...
            function setupScene() {
                ...
                target.position.set(
                    0,
                    0,
                    -(ground1.geometry.parameters.height / 2 - 1)
                );

                aim.position.z = -(
                    ground1.geometry.parameters.height / 2 -
                    1.5
                );
                ...
                camera.position.set(
                    0,
                    0,
                    ground1.geometry.parameters.height - 397.49
                );
            ...
            function limitAim() {
                if (aim.position.x > roomLimitWidth)
                    aim.position.x = roomLimitWidth;
                if (aim.position.x < -roomLimitWidth)
                    aim.position.x = -roomLimitWidth;

                if (aim.position.y > roomLimitHeight)
                    aim.position.y = roomLimitHeight;
                if (aim.position.y < -roomLimitHeight)
                    aim.position.y = -roomLimitHeight;
            ...
            toggle.addEventListener("touchstart", e => {
                ...
                e.preventDefault();
                toggle.innerText =
                    toggle.innerText === "Single" ? "Auto" : "Single";
            });
            /* =========================
               9️⃣ LOOP
            ========================= */
